namespace CocodriloDog.Core {
	...
	/// </summary>
	public class CollisionTrigger : CollisionTriggerBase<Collider, Collision, CollisionReaction, Vector3> {
	...
	[Serializable]
	public class CollisionReaction : CollisionReactionBase<Collision> { }
