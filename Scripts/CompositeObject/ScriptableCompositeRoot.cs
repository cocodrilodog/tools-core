namespace CocodriloDog.Core {
	...
	/// <summary>
	/// A base ScriptableObject class for root objects of composite structures that are made up from 
	/// concrete <see cref="CompositeObject"/>s.
	/// </summary>
	public class ScriptableCompositeRoot : ScriptableObject, ICompositeRoot {
