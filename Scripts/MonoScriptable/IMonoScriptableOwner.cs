namespace CocodriloDog.Core {
	...
	public interface IMonoScriptableOwner {
		...
		/// increases in size, the newly added elements are duplicates of the last item. At this time, the implementation
		/// of this method should search for duplicate references of <see cref="MonoScriptableObject"/> in arrays or lists given 
		/// that the property changes of the asset or component may have been from an array size increase. 
		/// </summary>
		void RecreateRepeatedMonoScriptableArrayOrListItem();
